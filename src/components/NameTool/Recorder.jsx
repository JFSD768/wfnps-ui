...
function Recorder({ userDetails, onStopSelect }) {
    ...
    const handleYes = () => {
        ...
        if (base64Audio !== "") axios.put(`${baseUrl}/${userDetails.id}`, { ...userDetails, prefPronunciation: base64Audio })
        setRecordState(null);
        setAudioData(null);
    ...
    return (<div>
            ...
            <DialogContent>
                {!(audioData && audioData.url) ? (<>
                    ...
                    {(recordState === null || recordState !== "start") && (<>
                        ...
                        <div> Go to a quiet place and then click on the record button </div>
        ...
        <Dialog onClose={handleInfoClose} aria-labelledby="customized-dialog-title" open={openInfoPanel}>
            ...
            <DialogContent>
                This will override your existing pronunciation. Do you want to proceed?
